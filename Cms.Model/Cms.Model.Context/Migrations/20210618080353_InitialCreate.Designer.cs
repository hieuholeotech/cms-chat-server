...
namespace Cms.Model.Context.Migrations
{
    ...
    [Migration("20210618080353_InitialCreate")]
            ...
            modelBuilder.Entity("Cms.Model.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "b58b2457-eb36-4b1c-bceb-fc42d775577e",
            ...
            modelBuilder.Entity("Cms.Model.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Address = "Đà Nẵng",
                            ConcurrencyStamp = "e532af67-7ec8-451e-ac2e-bce2af07243a",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAELVYQ2RFn2p8GbptHJLIMeRWfkbjjx0cyAMAuyUC9ZcQtyFbCEqDmh6vH7uteA/hvA==",
            ...
            modelBuilder.Entity("Cms.Model.Entities.Message", b =>
                {
                    ...
                    b.HasOne("Cms.Model.Entities.AppUser", "TargetUser")
                        .WithMany()
